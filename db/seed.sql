...
INSERT INTO gtr_users (
  ...
  ( 'Madhu', 'Sudan', 'madhus1', 'madhus@gmail.com', NULL, '212-212-2120', '646-515-1201', '{01,19,1992}', 'abcd1234', '212-212-2120', NULL, '121 Main Street', 'Central City', 'PA', '15061', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'John', 'Goodman', 'johng','johng@gmail.com', NULL, '212-212-2121', '646-515-1202', '{07,17,1983}', 'abcd1234', '646-515-1202', NULL, '121 Main Street', 'Central City', 'PA', '15062', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Wes', 'Reid', 'wesr', 'wesr@gmail.com', NULL, '212-212-2123', '646-515-1203', '{08,01,1991}', 'abcd1234', '212-212-2123', NULL, '121 Main Street', 'Central City', 'PA', '15063', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Tammy', 'Wynett', 'tammyw', 'tammyw@gmail.com', NULL, '212-212-2124', '646-515-1204', '{12, 20, 1948}', 'abcd1234', '212-212-2124', NULL, '121 Main Street', 'Central City', 'PA', '15064', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Abbie', 'Normal', 'abbien', 'abbie@gmail.com', NULL, '212-212-2125', '646-515-1204', '{11, 26, 1975}', 'abcd1234', NULL, NULL, '55 Wisteria Lane', 'Fairview', 'Eagle State', '15065', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Barbie', 'Myslak', 'barbiem', 'barbiem@gmail.com', NULL, '212-212-2126', '646-515-1205', '{10, 21, 1988}', 'abcd1234', NULL, NULL, '55 Wisteria Lane', 'Fairview', 'Eagle State', '15066', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Rachel', 'Feldman', 'rachelf', 'rachelf@gmail.com', NULL, '212-212-2127', '646-515-1206', '{09, 08, 2002}', 'abcd1234', NULL, NULL, '77 Cloud Vista Place', 'Clementine', 'NJ', '06302', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Olivia', 'Paris', 'oliviap', 'oliviap@gmail.com', NULL, '212-212-2127', '646-515-1206', '{06, 18, 1999}', 'abcd1234', NULL, NULL, NULL, NULL, 'NY', '10061', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Sandra', 'Justice', 'sandraj', 'sandra@hotmail.com', NULL, '212-212-2127', '646-515-1206', '{07, 18, 1993}', 'abcd1234', NULL, NULL, NULL, NULL, 'PA', '15061', false, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', NULL, NULL, CURRENT_TIMESTAMP ),
  ( 'Kenti', 'Johnson', 'kentij', 'rayjguitar@gmail.com', NULL, '212-212-2199', '646-515-1298', '{08, 11, 1996}', 'abcd1234', NULL, NULL, '422 Cherry Blossom Lane', 'Mountain City', 'NY', '10461', true, false, '{}', '{"Jazz"}', '{"Rock", "Blues", "Alternative"}', '{"Guitar", "Piano", "Bass" }', 'Jazz, Rock, Blues', 'Offering Guitar Lessons in the New York area since 1998!', CURRENT_TIMESTAMP );
